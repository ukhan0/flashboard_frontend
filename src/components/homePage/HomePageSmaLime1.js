  ...
  return (
    <Card className="card-box mb-4">
      <div className={classes.card}>
        <h2 className="card-header--title font-weight-bold">Social Top Ten Stocks</h2>
        <div className={classes.cardcontent} style={{ height: '450px', width: '600px' }} id="container"></div>
      </div>
    </Card>
  );
}
